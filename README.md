...
#### MUSE память (НОВОЕ v0.0.3):
- **Стратегическая:** Уроки из ошибок и способы их обхода
- **Процедурная:** SOPs (Standard Operating Procedures) для типовых задач
- **Инструментальная:** Паттерны эффективного использования инструментов
- **Рефлексия:** Автоматическая оценка выполнения задач и извлечение знаний
- **Подробнее:** См. [MUSE_DOCUMENTATION.md](doc/MUSE_DOCUMENTATION.md)
...
### 🔧 19 инструментов + 6 MUSE инструментов
...
- **MUSE (НОВОЕ):** view_strategic_lessons, view_procedural_sops, view_tool_hints, add_strategic_lesson, add_tool_hint, compress_muse_memory
- **Завершение:** finish
