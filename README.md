...
[![Version](https://img.shields.io/badge/version-0.0.3--alpha-blue.svg)](CHANGELOG.md)
...
### 🎨 Enhanced CLI (v0.0.3-alpha)
- **Статус в реальном времени:** Мониторинг контекста и памяти
- **Визуальное улучшение:** Панели, градиенты, иконки (вдохновлено gemini-cli)
...
- **Подробнее:** См. [ENHANCED_CLI_README.md](ENHANCED_CLI_README.md)
...
#### Enhanced CLI (Экспериментальный):
```bash
python enhanced_cli.py
```

**Enhanced CLI** включает:
- 📊 Статус-панель в реальном времени (контекст & память)
- 🎨 Улучшенный визуальный дизайн
- 📝 Предпросмотр кода перед записью
- 🔍 Подсветка синтаксиса

> **Note:** Enhanced CLI находится в экспериментальной ветке `cli-test`. См. [ENHANCED_CLI_README.md](ENHANCED_CLI_README.md) для деталей.
