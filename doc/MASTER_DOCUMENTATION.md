...
- Контекстное окно: **20,480 токенов**
- Flash Attention для экономии 20-30% VRAM
- KV-кэш квантизация (FP16) для экономии памяти
...
**Решение 2: Включить квантизацию KV-кэша**
```python
# Уже включено по умолчанию в v2.1.0+
...
self.llm = Llama(
    ...
    n_ctx=20480,           # Контекст 20k токенов
    n_threads=8,           # CPU потоки
    n_gpu_layers=-1,       # Все слои на GPU
    verbose=False,
    flash_attn=True,       # Flash Attention
    cache_type_k="f16",    # KV-кэш квантизация
    cache_type_v="f16"
)
```
